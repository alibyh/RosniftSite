        ...
        <Paper className="admin-paper">
          ...
          <TabPanel value={tabValue} index={0}>
            <Box className="admin-section-header">
              <Typography variant="h6">Управление Торговая Премияю по БЕ</Typography>
            </Box>
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Торговая Премия, %</TableCell>
                    <TableCell />
                  </TableRow>
                </TableHead>
                <TableBody>
